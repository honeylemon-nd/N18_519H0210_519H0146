...
(function ($, window, document, undefined) {
    ...
    $.extend(simpleCart.prototype, {
        ...
        _setupCart: function () {
            ...
            this.cart_ele.append("<div class='panel-heading cart-heading'><div class='total-cart-count'>Your Cart 0 items</div><div class='spacer'></div><i class=' total-cart-cost'>0</i>&#8363<div></div></div>")
            ...
            this.cart_ele.append("<div class='cart-summary-container'>\n\
                                <div class='cart-offer'></div>\n\
                                        <div class='cart-total-amount'>\n\
                                            ...
                                            <div><h4><i class=' total-cart-cost'>0</i>&#8363</h4></div>\n\
                                            </div>\n\
                                            \n\</div>");
            },
        ...
        _displayCart: function () {
            ...
            for (var i in cartArray) {
                output += "<div class='cart-each-product'>\n\
                       ...
                       <div class='quantity-am'>" + cartArray[i].price + "&#8363</div>\n\
                       </div>";
            }
            return output;
        },
